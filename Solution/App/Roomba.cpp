...
void Roomba::draw( ) const {
	...
	drawer->setEffect( Drawer::Effect( EFFECT_LASER, _balls[ BALL_LEFT ]->getPos( ), 1.0, Vector( 0, 0, angle_left ) ) );
	...
	drawer->setEffect( Drawer::Effect( EFFECT_LASER, _balls[ BALL_RIGHT ]->getPos( ), 1.0, Vector( 0, 0, angle_right ) ) );
}
